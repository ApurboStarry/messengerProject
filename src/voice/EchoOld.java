...
public class EchoOld
{
    public static void main(String[] args) throws Exception

    {
        ServerSocket serverSocket = new ServerSocket(3000);
        while(true){Thread echoThread = new Thread(new EchoThreadOld(serverSocket.accept()));
            echoThread.start();}
    }
}

class EchoThreadOld implements Runnable
{
    ...
    public EchoThreadOld(Socket conn) throws Exception
    {
        connection = conn;
